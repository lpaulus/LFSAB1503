...
On sait que réaction dégage \unit{92.22}{kJ/\mole}, on considère que l'eau est injectée à \unit{25}{\celsius} et qu'une fois qu'elle atteint la température de \unit{90}{\celsius} elle ressort du circuit. 
...
$$ 75.29\cdot 65 \cdot x = 92.22\cdot 10^3 \cdot 58.8 \cdot 10^6$$% pas complet
il nous faut \unit{738687}{$m^3$/jour} pour refroidir la production de \unit{1000}{\tonne} d'ammoniac. Cela est équivalent à un débit de \unit{205}{m^3/\second}.
